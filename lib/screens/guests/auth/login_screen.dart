import 'package:ent_insight_app/screens/guests/auth/register_screen.dart';
import 'package:ent_insight_app/services/firebase_auth_service.dart';
import 'package:ent_insight_app/utils/auth_checker.dart';
          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                children: [
                  const TopAppBar(),
                  Image.asset("assets/images/idea-bulb.png"),
                  ...
                  const SizedBox(height: 20),
                  Image.asset(
                    'assets/images/social_login_divider_or.png',
                  ),
                  const SizedBox(height: 10),
                  Row(
